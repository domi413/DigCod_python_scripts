...
def decimal_to_binary_with_point(decimal_number, precision):
    ...
    binary_number_with_point = binary_integer_part + '.' + binary_fractional_part
...
while True:
    ...
    input_number = float(input("Enter a decimal number: "))
    input_precision = int(input("Enter precision of datatype: "))
    print(decimal_to_binary_with_point(input_number, input_precision))

    if input("Rerun code? (y)") != "y":
        break
